...
class ImagePipelineController extends Controller
{
    ...
    {
        $this->minApproved = (int) env('MIN_APPROVED_IMAGES', 1);
    }
    ...
    public function approveAll($yachtId): JsonResponse
    {
        ...
        $approvedCount = $yacht->images()->approved()->count();
        $processingCount = $yacht->images()->processing()->count() + $yacht->images()->where('enhancement_method', 'pending')->count();
