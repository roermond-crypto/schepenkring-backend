...
class Yacht extends Model
{
    ...
    // ─── Sub-table relationship → field mapping ────────────────
    ...
    public function boatVideos(): HasMany
    {
        return $this->hasMany(BoatVideo::class);
    }

    public function videoSettings(): HasOne
    {
    ...
    {
        return $this->hasMany(YachtFinancialLog::class);
    }

    /**
     * Image embeddings for boat recognition.
     */
    ...
    {
        return $this->belongsToMany(User::class, 'boat_likes')->withTimestamps();
    }
