...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Der angegebene Wert für :attribute wurde in einem bekannten Datenleck gefunden. Bitte wählen Sie ein anderes :attribute.',
    ],
    ...
    'prohibited_unless' => 'Das Feld :attribute ist nicht erlaubt, es sei denn, :other liegt in :values.',
    ...
    'required_unless' => 'Das Feld :attribute ist erforderlich, es sei denn, :other liegt in :values.',
    ...
    'custom' => [
        'birth_date' => [
            'date' => 'Bitte geben Sie ein gültiges Geburtsdatum ein (TT-MM-JJJJ).',
    ...
    'attributes' => [
        ...
        'kvk_number' => 'Handelskammer-Nummer (KVK)',
