...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur donnée pour :attribute est apparue dans une fuite de données. Veuillez choisir un(e) autre :attribute.',
    ],
    ...
    'prohibited_unless' => "Le champ :attribute n'est pas autorisé sauf si :other figure dans :values.",
    ...
    'custom' => [
        'birth_date' => [
            'date' => 'Veuillez saisir une date de naissance valide (JJ-MM-AAAA).',
    ...
    'attributes' => [
        ...
        'kvk_number' => 'numéro de chambre de commerce (KVK)',
